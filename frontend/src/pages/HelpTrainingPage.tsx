      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: 20 }}>
        ...
        <div className="card-level-1">
          ...
          <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            ...
            All safety incident figures (fatalities, serious injuries, and Lost Time Injury Frequency Rates) are extracted with 100% ground-truth provenance and verifiable document citations.
          </p>
        </div>
        ...
        <div className="card-level-1">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            ...
            <h3 className="card-title" style={{ margin: 0 }}>ISO/IEC 25010 Quality Benchmark Model</h3>
          </div>
          <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            Defines the 8 formal quality benchmark KPIs distinguishing project targets from actual empirical test results.
            Enforces evidence-grounded response gating across all AI-generated answers, parliamentary drafts, and executive reports.
          </p>
        </div>

        {/* 3. 8-Agent Orchestration Architecture */}
        <div className="card-level-1">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
