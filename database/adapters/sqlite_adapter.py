...
class SQLiteAdapter(BaseDatabaseAdapter):
    ...
    def _run_column_migrations(self, conn: sqlite3.Connection) -> None:
        ...
        migrations = [
            ...
            ("agent_workflows", "document_name", "TEXT"),
            ("validation_issues", "resolved_by", "TEXT"),
            ("validation_issues", "resolved_note", "TEXT"),
            ("validation_issues", "adopted_source", "TEXT"),
            ("validation_issues", "resolved_value", "TEXT"),
            ("validation_issues", "decision_type", "TEXT"),
            ("reports", "report_id_str", "TEXT"),
            ("reports", "run_id", "TEXT"),
            ("reports", "version_number", "INTEGER DEFAULT 1"),
            ("reports", "document_id", "INTEGER"),
            ("reports", "quality_gate_status", "TEXT DEFAULT 'PASSED'"),
            ("reports", "human_review_status", "TEXT DEFAULT 'NOT_REQUIRED'"),
            ("reports", "discrepancy_count", "INTEGER DEFAULT 0"),
            ("reports", "evidence_count", "INTEGER DEFAULT 0"),
            ("reports", "docx_path", "TEXT"),
            ("reports", "file_path", "TEXT"),
            ("reports", "pdf_path", "TEXT"),
